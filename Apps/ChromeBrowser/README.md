...
> [!WARNING]
> Of course it won't work on iOS. Chrome on iOS is limited to Apple's WebKit, which does not implement BLE access.
>
> But it works on MACOs (Chrome and Edge)... Apple ecosystem homogeneity is a joke.
> 


It also works with Edge on Windows and MacOs.

If you cloned or forked this repo, you can run a local server on your machine and access this page, or, you can access its published version here:
